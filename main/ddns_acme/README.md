...
При много игра със сертификати, май не се обновяват нови и стари в компютъра. Трябва да се внимава кой избираме когато ни пита, иначе се самооправя след до няколко дни. Желателно е ресет на компютъра.

Ако се правят експирименти, много е желателно staging мод в production често ни наказва за ден или 2-3.

Засега не е решен въпроса с изтекъл сертификат. Видя се че трябва чисто нов (затриване през ftp на цялото директори). Трябва да следим за напълно изтекъл и да издаваме нов на автомат.
