...
Използва [ESP-IDF](https://docs.espressif.com/projects/esp-idf/en/latest/esp32/get-started/index.html) **v5.3.1, v5.4, v5.5.4** на кит с процесор ESP32-S3-N16R8 и трицветен светодиод WS2812B, към извод GPIO48.
...
**ЗАБЕЛЕЖКА** Понеже проекта е учебен, не се задълбочавам да създавам пълен `Kconfig` файл. Всичко се настройва, чрез `secrets.h`, който го няма в GitHub. Но има `secrets_demo.h`, който да преименувате и да настроите. Всички изброени по-долу допълнения, могат да се разрешават, чрез тези файлове.
...
Получаване на сертифика, чрез [ACME client](https://letsencrypt.org/docs/client-options/).
